...
$ helm install --name my-release \
  --set factorioServer.factorioServer=My Server,ImageTag=0.16.51 \
    stable/factorio
```

The above command deploys Factorio dedicated with a server name of `My Server` and docker-factorio image version `0.16.51`.
...
The [dtanderson/factorio](https://hub.docker.com/r/dtandersen/factorio) image stores the saved games and mods under /opt/factorio.
